...
{
    public class EstadoDocenteMapping:EntityTypeConfiguration<EstadoDocente>
    {
        public EstadoDocenteMapping()
        {
            this.HasKey(r => r.Id);
            ...
            //table
            this.ToTable("EstadoDocente");

            //Relaciones
            this.HasRequired(r => r.Persona)
                .WithMany(d=>d.EstadoDocentes)
